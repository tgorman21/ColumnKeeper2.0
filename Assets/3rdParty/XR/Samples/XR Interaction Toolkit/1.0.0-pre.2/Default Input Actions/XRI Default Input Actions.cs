// GENERATED AUTOMATICALLY FROM 'Assets/3rdParty/XR/Samples/XR Interaction Toolkit/1.0.0-pre.2/Default Input Actions/XRI Default Input Actions.inputactions'
...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""51aac6c6-aefe-4f3c-8b56-944ae633fea5"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                ...
                },
                {
                    ""name"": ""Grip"",
                    ""type"": ""Value"",
                    ""id"": ""3690e6ce-63a5-4a9e-8553-117327400ae0"",
                ...
                },
                {
                    ""name"": ""Trigger"",
                    ""type"": ""Value"",
                    ""id"": ""99b3dff7-7796-40f7-99df-c1d0c103aa51"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c9f2db5f-018c-4a5e-837e-903a81a2b5d7"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f4193d90-c4da-470a-8086-8ddb458a4eed"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8cfe58a1-9d99-4320-b49f-74f7645355c2"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Grip"",
                    ""type"": ""Value"",
                    ""id"": ""7137daa3-7a5d-400f-a6e8-90f5ae7805d8"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Trigger"",
                    ""type"": ""Value"",
                    ""id"": ""2dfdb79a-7fa7-40dc-98d7-7caec9f7f4a4"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""AbilityDial"",
                    ""type"": ""Button"",
                    ""id"": ""0efd098b-a5de-402f-aef0-1cf766c8ad62"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                ...
                },
                {
                    ""name"": ""A"",
                    ""type"": ""Button"",
                    ""id"": ""f18e47f7-5868-4bc3-8a27-ef9a7ad93663"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""69236aa7-05ad-433f-9585-f84faa61afd0"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8053c09f-e27a-420e-ac1d-41fa4c40541e"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_Sprint = m_XRILeftHand.FindAction("Sprint", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHand_Sprint;
    ...
    public struct XRILeftHandActions
    {
        ...
        public InputAction @Sprint => m_Wrapper.m_XRILeftHand_Sprint;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @Sprint.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSprint;
                @Sprint.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSprint;
                @Sprint.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSprint;
